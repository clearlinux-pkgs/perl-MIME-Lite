...
cp %{_builddir}/MIME-Lite-%{version}/COPYING %{buildroot}/usr/share/package-licenses/perl-MIME-Lite/aa57d45530d46f5b52279b5d703112dda67cbdc1 || :
cp %{_builddir}/MIME-Lite-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-MIME-Lite/f11692fc652e231edd2a23a60c72d9be8a840e0c || :
if test -f Makefile.PL; then
